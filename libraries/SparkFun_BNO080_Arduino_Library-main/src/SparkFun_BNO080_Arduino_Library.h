...
{
public:
	boolean begin(uint8_t deviceAddress = BNO080_DEFAULT_ADDRESS, i2c_t3 &wirePort = Wire, uint8_t intPin = 255); //By default use the default I2C addres, and use Wire port, and don't declare an INT pin
