...
public:
  ...
  Adafruit_SH110X(uint16_t w, uint16_t h, i2c_t3 *twi = &Wire,
...
public:
  Adafruit_SH1106G(uint16_t w, uint16_t h, i2c_t3 *twi = &Wire,
                   int8_t rst_pin = -1, uint32_t preclk = 400000,
                   uint32_t postclk = 100000);
...
public:
  Adafruit_SH1107(uint16_t w, uint16_t h, i2c_t3 *twi = &Wire,
                  int8_t rst_pin = -1, uint32_t preclk = 400000,
                  uint32_t postclk = 100000);
